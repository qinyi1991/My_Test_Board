...
{
    static uint32_t Cu_Encoder_left_Var=0,Pr_Encoder_left_Var=0;
    static uint32_t Cu_Encoder_right_Var=0,Pr_Encoder_right_Var=0;
    static uint8_t  Flag_Dir;
    
    Encoder_interface(&Cu_Encoder_left_Var,&Cu_Encoder_right_Var); 
    ...
    //第三步，调试参数
    //左驱动轮输出，增量模式
    //if(Cu_Encoder_left_Var > Pr_Encoder_left_Va) {
      
      //正转
 //     Flag_Dir=1;
 //     Encoder_left_Var=Cu_Encoder_left_Var-Pr_Encoder_left_Var;  //计算速度差值
      
      //跨越 4095  ---   1
      
      
      
 //   }else if(Cu_Encoder_left_Var<Pr_Encoder_left_Va){
      
      //反转
//      Flag_Dir=0;
//      Encoder_left_Var=Cu_Encoder_left_Var-Pr_Encoder_left_Var;  //计算速度差值，速度为负值
...
//   Encoder_left_Var=((Cu_Encoder_left_Var&0xfff)+4096-(Pr_Encoder_left_Var&0xfff))%4096; //计算速度差值
//  Encoder_LCylinder_Var=(Cu_Encoder_left_Var&0xfff000)>>12; //计算当前圈数 
//  Position_Left = Cu_Encoder_left_Var; //总体脉冲数
//  Pr_Encoder_left_Var=Cu_Encoder_left_Var;  //保留上次编码器读值
//  //右驱动轮输出
//  Encoder_right_Var=((Cu_Encoder_right_Var&0xfff)+4096-(Pr_Encoder_right_Var&0xfff))%4096; //计算速度差值
//  Encoder_RCylinder_Var=(Cu_Encoder_right_Var&0xfff000)>>12; //计算当前圈数
//  Position_Right= Cu_Encoder_right_Var; //总体脉冲数
//  Pr_Encoder_right_Var=Cu_Encoder_right_Var; //保留上次编码器读值
    
    Encoder_left_Var = Cu_Encoder_left_Var;
    Encoder_right_Var = Cu_Encoder_right_Var;
